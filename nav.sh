...
# 模擬
ros2 launch ros2_control_demo_example_2 diffbot_sim.launch.py

# 建圖
ros2 launch slam_toolbox online_async_launch.py slam_params_file:=/home/alan/mydiffbot_ws/src/example_2/bringup/config/mapper_params_online_async.yaml  use_sim_time:=true

# 載入地圖 導航
ros2 launch slam_toolbox online_async_launch.py slam_params_file:=/home/alan/mydiffbot_ws/src/example_2/bringup/config/localization_mapper_params_online_async.yaml use_sim_time:=true
ros2 launch nav2_bringup navigation_launch.py params_file:=/home/alan/mydiffbot_ws/src/example_2/bringup/config/nav2_params.yaml use_sim_time:=true
ros2 run twist_mux twist_mux --ros-args --params-file ./src/example_2/bringup/config/twist_mux.yaml -r cmd_vel_out:=cmd_vel -p use_stamped:=true
ros2 launch teleop_twist_joy teleop-launch.py joy_config:='xbox' publish_stamped_twist:=True joy_vel:=cmd_vel_joy

ros2 run nav2_map_server map_saver_cli -f src/example_2/bringup/maps/sim_map # 儲存地圖
